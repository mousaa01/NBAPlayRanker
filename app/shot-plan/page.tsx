...
type ShotRow = Record<string, any> & {
  ...
  // “Why” text generated by the backend to support explainability (committee-friendly)
  RATIONALE?: string;
};
...
export default function ShotPlanPage() {
  ...
  // IMPORTANT: backend validates this as Top-K (1..10).
  // The shot-plan ranker returns “top K” shot types + zones, not a full list.
  ...
  // Toggle to show textual rationale for the top recommendation (explainability).
      ...
      <section className="card">
        ...
        {!rank ? (
          ...
          <>
            ...
            {/* Quick picks = fast “headline” summary for committee / demo */}
            <div
              className="grid"
